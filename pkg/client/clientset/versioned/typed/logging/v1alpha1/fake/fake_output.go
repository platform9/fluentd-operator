...
func (c *FakeOutputs) Get(name string, options v1.GetOptions) (result *v1alpha1.Output, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewGetAction(outputsResource, c.ns, name), &v1alpha1.Output{})
...
func (c *FakeOutputs) List(opts v1.ListOptions) (result *v1alpha1.OutputList, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewListAction(outputsResource, outputsKind, c.ns, opts), &v1alpha1.OutputList{})
...
func (c *FakeOutputs) Create(output *v1alpha1.Output) (result *v1alpha1.Output, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewCreateAction(outputsResource, c.ns, output), &v1alpha1.Output{})
...
func (c *FakeOutputs) Update(output *v1alpha1.Output) (result *v1alpha1.Output, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateAction(outputsResource, c.ns, output), &v1alpha1.Output{})
...
func (c *FakeOutputs) UpdateStatus(output *v1alpha1.Output) (*v1alpha1.Output, error) {
	obj, err := c.Fake.
		Invokes(testing.NewUpdateSubresourceAction(outputsResource, "status", c.ns, output), &v1alpha1.Output{})
...
func (c *FakeOutputs) Delete(name string, options *v1.DeleteOptions) error {
	_, err := c.Fake.
		Invokes(testing.NewDeleteAction(outputsResource, c.ns, name), &v1alpha1.Output{})
...
func (c *FakeOutputs) Patch(name string, pt types.PatchType, data []byte, subresources ...string) (result *v1alpha1.Output, err error) {
	obj, err := c.Fake.
		Invokes(testing.NewPatchSubresourceAction(outputsResource, c.ns, name, data, subresources...), &v1alpha1.Output{})
